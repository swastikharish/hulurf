...
class Uploadhandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/assets/img/files/',
            'upload_url' => $this->get_full_url().'/assets/img/files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
   ...
   protected function get_file_size($file_path, $clear_stat_cache = false) {
    ...
    protected function get_unique_filename($name,
        ...
        //$name = rand(0, 9999999999).date("Ymdhis").'.'.end($name_array);
        return $name;
    }
    ...
    protected function gd_create_scaled_image($file_name, $version, $options) {
        ...
        if (!empty($options['resize']) && !empty($options['max_width']) && !empty($options['max_height'])) {
            if($scale == 1){
                if ($image_oriented) {
            ...
            $dst_x = (int)(($max_width-$new_width)/2);
            $dst_y = (int)(($max_height-$new_height)/2);
            ...
            imagefilledrectangle($new_img, 0, 0, $max_width, $max_height, $background);
    ...
    protected function create_scaled_image($file_name, $version, $options) {
        ...
        if ($this->options['image_library'] && extension_loaded('imagick') && false) {
