<div class="bg-light lter b-b wrapper-md">
  <div class="clearfix">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="m-n font-thin h3 pull-left">Edit Template</h1>
      </div>
      <div class="col-sm-6 text-right">
        <a href="<?php echo site_url($this->admin_folder.'templates'); ?>" class="btn btn-sm btn-default"> <i class="fa fa-arrow-left"></i> Back</a>
      </div>
    </div>
  </div>
</div>
<div class="wrapper-md">
  ...
  <div class="panel panel-default">
    <form name="template_form" class="template-form form-horizontal" id="template-form">
        ...
        <div class="row">
          <div class="col-sm-12">            
            <div class="form-group required">
              <label for="input-template-content" class="col-sm-3 control-label">Content</label>
              <div class="col-sm-8">
                <div class="btn-toolbar m-b-sm btn-editor" data-role="editor-toolbar" data-target="#input-template-content">
                  <div class="btn-group">
                ...
                <div ui-jq="wysiwyg" id="input-template-content" class="form-control" style="overflow:scroll;height:200px;max-height:200px"><?php echo $content; ?></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-sm-12">
            <div class="row">
              <div class="col-sm-9 col-sm-offset-3">
                <a href="<?php echo site_url($this->admin_folder.'templates'); ?>" class="btn btn-default">Cancel</a>
                <button type="submit" class="btn btn-info" id="button-template-save">Save</button>
              </div>
            </div>
          </div>
        </div>
